/* Generated by Cython 0.13 on Fri May  6 16:39:43 2011 */
...
static char __pyx_k_10[] = "norm (line 32)";
static char __pyx_k_11[] = "cross (line 46)";
static char __pyx_k_12[] = "dot (line 67)";
static char __pyx_k_13[] = "validity (line 88)";
...
/* "/home/martin/repos/imusim/imusim/maths/vectors.pyx":29
 * __all__ = ['vector']
 * 
...
static PyObject *__pyx_pf_6imusim_5maths_7vectors_vector(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "/home/martin/repos/imusim/imusim/maths/vectors.pyx":30
 * 
 * def vector(*components):
 *     return np.array([components],dtype=np.float64).T             # <<<<<<<<<<<<<<
 * 
...
/* "/home/martin/repos/imusim/imusim/maths/vectors.pyx":32
 *     return np.array([components],dtype=np.float64).T
 * 
 * def norm(np.ndarray[np.float64_t, ndim=2] vectors):             # <<<<<<<<<<<<<<
 *     """
...
static PyObject *__pyx_pf_6imusim_5maths_7vectors_norm(PyObject *__pyx_self, PyObject *__pyx_v_vectors); /*proto*/
static char __pyx_doc_6imusim_5maths_7vectors_norm[] = "\n    Compute the l2norm of an array of column vectors\n    ";
static PyObject *__pyx_pf_6imusim_5maths_7vectors_norm(PyObject *__pyx_self, PyObject *__pyx_v_vectors) {
  ...
  /* "/home/martin/repos/imusim/imusim/maths/vectors.pyx":38
 *     cdef Py_ssize_t i
 *     cdef Py_ssize_t j
 ...
 */
  ...
  /* "/home/martin/repos/imusim/imusim/maths/vectors.pyx":39
 *     cdef Py_ssize_t j
 *     cdef np.ndarray[np.float64_t, ndim=1] norms = np.empty(vectors.shape[1])
 *     for i in range(vectors.shape[1]):             # <<<<<<<<<<<<<<
 *         norms[i] = 0
 ...
 */
  ...
  for (__pyx_t_6 = 0; __pyx_t_6 < __pyx_t_5; __pyx_t_6+=1) {
    ...
    /* "/home/martin/repos/imusim/imusim/maths/vectors.pyx":40
 *     cdef np.ndarray[np.float64_t, ndim=1] norms = np.empty(vectors.shape[1])
 *     for i in range(vectors.shape[1]):
 *         norms[i] = 0             # <<<<<<<<<<<<<<
 *         for j in range(vectors.shape[0]):
 ...
 */
    ...
    *__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float64_t *, __pyx_bstruct_norms.buf, __pyx_t_7, __pyx_bstride_0_norms) = 0.0;
    ...
    /* "/home/martin/repos/imusim/imusim/maths/vectors.pyx":41
 *     for i in range(vectors.shape[1]):
 *         norms[i] = 0
 *         for j in range(vectors.shape[0]):             # <<<<<<<<<<<<<<
 *             norms[i] += vectors[j,i] * vectors[j,i]
 ...
 */
    ...
    for (__pyx_t_10 = 0; __pyx_t_10 < __pyx_t_9; __pyx_t_10+=1) {
      ...
      /* "/home/martin/repos/imusim/imusim/maths/vectors.pyx":42
 *         norms[i] = 0
 *         for j in range(vectors.shape[0]):
 *             norms[i] += vectors[j,i] * vectors[j,i]             # <<<<<<<<<<<<<<
 *         norms[i] = sqrt(norms[i])
 ...
 */
    ...
    /* "/home/martin/repos/imusim/imusim/maths/vectors.pyx":43
 *         for j in range(vectors.shape[0]):
 *             norms[i] += vectors[j,i] * vectors[j,i]
 *         norms[i] = sqrt(norms[i])             # <<<<<<<<<<<<<<
 *     return norms
 ...
 */
  ...
  /* "/home/martin/repos/imusim/imusim/maths/vectors.pyx":44
 *             norms[i] += vectors[j,i] * vectors[j,i]
 *         norms[i] = sqrt(norms[i])
 *     return norms             # <<<<<<<<<<<<<<
 * 
...
/* "/home/martin/repos/imusim/imusim/maths/vectors.pyx":46
 *     return norms
 * 
 * def cross(np.ndarray[np.float64_t, ndim=2] v1,             # <<<<<<<<<<<<<<
...
static PyObject *__pyx_pf_6imusim_5maths_7vectors_cross(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_6imusim_5maths_7vectors_cross[] = "\n    Compute the cross products of two arrays of column vectors.\n\n    Each array of vectors must have the same shape\n    ";
static PyObject *__pyx_pf_6imusim_5maths_7vectors_cross(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "/home/martin/repos/imusim/imusim/maths/vectors.pyx":54
 *     """
 *     cdef Py_ssize_t i
 ...
 */
  ...
  /* "/home/martin/repos/imusim/imusim/maths/vectors.pyx":56
 *     cdef np.ndarray[np.float64_t, ndim=2] crossProduct = np.empty((3,v1.shape[1]))
 * 
 *     assert v1.shape[0] == v2.shape[0] == 3 and v1.shape[1] == v2.shape[1], \             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (unlikely(!__pyx_t_8)) {
    ...
    /* "/home/martin/repos/imusim/imusim/maths/vectors.pyx":58
 *     assert v1.shape[0] == v2.shape[0] == 3 and v1.shape[1] == v2.shape[1], \
 *             "Vectors must both have shape (3,%d). (v1.shape=(%d, %d), v2." \
 *             "shape=(%d, %d)" %(v1.shape[1], v1.shape[0], v1.shape[1],             # <<<<<<<<<<<<<<
 ...
 */
    ...
    /* "/home/martin/repos/imusim/imusim/maths/vectors.pyx":59
 *             "Vectors must both have shape (3,%d). (v1.shape=(%d, %d), v2." \
 *             "shape=(%d, %d)" %(v1.shape[1], v1.shape[0], v1.shape[1],
 *                     v2.shape[0], v2.shape[1])             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    __pyx_t_9 = 0;
    __pyx_t_10 = 0;
    __pyx_t_10 = PyNumber_Remainder(((PyObject *)__pyx_kp_s_1), __pyx_t_11); if (unlikely(!__pyx_t_10)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 58; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  /* "/home/martin/repos/imusim/imusim/maths/vectors.pyx":61
 *                     v2.shape[0], v2.shape[1])
 * 
 *     for i in range(v1.shape[1]):             # <<<<<<<<<<<<<<
 ...
 */
  ...
  for (__pyx_t_12 = 0; __pyx_t_12 < __pyx_t_5; __pyx_t_12+=1) {
    ...
    /* "/home/martin/repos/imusim/imusim/maths/vectors.pyx":62
 * 
 *     for i in range(v1.shape[1]):
 *         crossProduct[0,i] = v1[1,i] * v2[2,i] - v1[2,i] * v2[1,i]             # <<<<<<<<<<<<<<
 *         crossProduct[1,i] = v1[2,i] * v2[0,i] - v1[0,i] * v2[2,i]
 ...
 */
    ...
    *__Pyx_BufPtrStrided2d(__pyx_t_5numpy_float64_t *, __pyx_bstruct_crossProduct.buf, __pyx_t_22, __pyx_bstride_0_crossProduct, __pyx_t_23, __pyx_bstride_1_crossProduct) = (((*__Pyx_BufPtrStrided2d(__pyx_t_5numpy_float64_t *, __pyx_bstruct_v1.buf, __pyx_t_13, __pyx_bstride_0_v1, __pyx_t_14, __pyx_bstride_1_v1)) * (*__Pyx_BufPtrStrided2d(__pyx_t_5numpy_float64_t *, __pyx_bstruct_v2.buf, __pyx_t_16, __pyx_bstride_0_v2, __pyx_t_17, __pyx_bstride_1_v2))) - ((*__Pyx_BufPtrStrided2d(__pyx_t_5numpy_float64_t *, __pyx_bstruct_v1.buf, __pyx_t_18, __pyx_bstride_0_v1, __pyx_t_19, __pyx_bstride_1_v1)) * (*__Pyx_BufPtrStrided2d(__pyx_t_5numpy_float64_t *, __pyx_bstruct_v2.buf, __pyx_t_20, __pyx_bstride_0_v2, __pyx_t_21, __pyx_bstride_1_v2))));
    ...
    /* "/home/martin/repos/imusim/imusim/maths/vectors.pyx":63
 *     for i in range(v1.shape[1]):
 *         crossProduct[0,i] = v1[1,i] * v2[2,i] - v1[2,i] * v2[1,i]
 *         crossProduct[1,i] = v1[2,i] * v2[0,i] - v1[0,i] * v2[2,i]             # <<<<<<<<<<<<<<
 *         crossProduct[2,i] = v1[0,i] * v2[1,i] - v1[1,i] * v2[0,i]
 ...
 */
    ...
    *__Pyx_BufPtrStrided2d(__pyx_t_5numpy_float64_t *, __pyx_bstruct_crossProduct.buf, __pyx_t_32, __pyx_bstride_0_crossProduct, __pyx_t_33, __pyx_bstride_1_crossProduct) = (((*__Pyx_BufPtrStrided2d(__pyx_t_5numpy_float64_t *, __pyx_bstruct_v1.buf, __pyx_t_24, __pyx_bstride_0_v1, __pyx_t_25, __pyx_bstride_1_v1)) * (*__Pyx_BufPtrStrided2d(__pyx_t_5numpy_float64_t *, __pyx_bstruct_v2.buf, __pyx_t_26, __pyx_bstride_0_v2, __pyx_t_27, __pyx_bstride_1_v2))) - ((*__Pyx_BufPtrStrided2d(__pyx_t_5numpy_float64_t *, __pyx_bstruct_v1.buf, __pyx_t_28, __pyx_bstride_0_v1, __pyx_t_29, __pyx_bstride_1_v1)) * (*__Pyx_BufPtrStrided2d(__pyx_t_5numpy_float64_t *, __pyx_bstruct_v2.buf, __pyx_t_30, __pyx_bstride_0_v2, __pyx_t_31, __pyx_bstride_1_v2))));
    ...
    /* "/home/martin/repos/imusim/imusim/maths/vectors.pyx":64
 *         crossProduct[0,i] = v1[1,i] * v2[2,i] - v1[2,i] * v2[1,i]
 *         crossProduct[1,i] = v1[2,i] * v2[0,i] - v1[0,i] * v2[2,i]
 *         crossProduct[2,i] = v1[0,i] * v2[1,i] - v1[1,i] * v2[0,i]             # <<<<<<<<<<<<<<
 *     return crossProduct
 ...
 */
  ...
  /* "/home/martin/repos/imusim/imusim/maths/vectors.pyx":65
 *         crossProduct[1,i] = v1[2,i] * v2[0,i] - v1[0,i] * v2[2,i]
 *         crossProduct[2,i] = v1[0,i] * v2[1,i] - v1[1,i] * v2[0,i]
 *     return crossProduct             # <<<<<<<<<<<<<<
 * 
...
/* "/home/martin/repos/imusim/imusim/maths/vectors.pyx":67
 *     return crossProduct
 * 
 * def dot(np.ndarray[np.float64_t, ndim=2] v1,             # <<<<<<<<<<<<<<
 *         np.ndarray[np.float64_t, ndim=2] v2):
...
static PyObject *__pyx_pf_6imusim_5maths_7vectors_dot(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_6imusim_5maths_7vectors_dot[] = "\n    Compute the dot products of two arrays of column vectors.\n\n    Each array must have the same shape\n    ";
static PyObject *__pyx_pf_6imusim_5maths_7vectors_dot(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyArrayObject *__pyx_v_v1 = 0;
  PyArrayObject *__pyx_v_v2 = 0;
  Py_ssize_t __pyx_v_i;
  ...
  /* "/home/martin/repos/imusim/imusim/maths/vectors.pyx":75
 *     """
 *     cdef Py_ssize_t i
 ...
 */
  ...
  /* "/home/martin/repos/imusim/imusim/maths/vectors.pyx":77
 *     cdef np.ndarray[np.float64_t, ndim=1] dotProduct = np.empty(v1.shape[1])
 * 
 *     assert v1.shape[0] == v2.shape[0] and v1.shape[1] == v2.shape[1], \             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (unlikely(!__pyx_t_7)) {
    ...
    /* "/home/martin/repos/imusim/imusim/maths/vectors.pyx":79
 *     assert v1.shape[0] == v2.shape[0] and v1.shape[1] == v2.shape[1], \
 *             "Vectors must both have shape (%d,%d). (v1.shape=(%d, %d), v2." \
 *             "shape=(%d, %d)" %(v1.shape[0], v1.shape[1], v1.shape[0], v1.shape[1],             # <<<<<<<<<<<<<<
 *                     v2.shape[0], v2.shape[1])
 ...
 */
    ...
    /* "/home/martin/repos/imusim/imusim/maths/vectors.pyx":80
 *             "Vectors must both have shape (%d,%d). (v1.shape=(%d, %d), v2." \
 *             "shape=(%d, %d)" %(v1.shape[0], v1.shape[1], v1.shape[0], v1.shape[1],
 *                     v2.shape[0], v2.shape[1])             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    __pyx_t_9 = 0;
    __pyx_t_10 = 0;
    __pyx_t_10 = PyNumber_Remainder(((PyObject *)__pyx_kp_s_2), __pyx_t_11); if (unlikely(!__pyx_t_10)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 79; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(((PyObject *)__pyx_t_10));
    __Pyx_DECREF(__pyx_t_11); __pyx_t_11 = 0;
    PyErr_SetObject(PyExc_AssertionError, ((PyObject *)__pyx_t_10));
    __Pyx_DECREF(((PyObject *)__pyx_t_10)); __pyx_t_10 = 0;
  ...
  /* "/home/martin/repos/imusim/imusim/maths/vectors.pyx":82
 *                     v2.shape[0], v2.shape[1])
 * 
 *     for i in range(v1.shape[1]):             # <<<<<<<<<<<<<<
 *         dotProduct[i] = 0
 ...
 */
  ...
  for (__pyx_t_13 = 0; __pyx_t_13 < __pyx_t_12; __pyx_t_13+=1) {
    ...
    /* "/home/martin/repos/imusim/imusim/maths/vectors.pyx":83
 * 
 *     for i in range(v1.shape[1]):
 *         dotProduct[i] = 0             # <<<<<<<<<<<<<<
 *         for j in range(v1.shape[0]):
 ...
 */
    ...
    *__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float64_t *, __pyx_bstruct_dotProduct.buf, __pyx_t_14, __pyx_bstride_0_dotProduct) = 0.0;
    ...
    /* "/home/martin/repos/imusim/imusim/maths/vectors.pyx":84
 *     for i in range(v1.shape[1]):
 *         dotProduct[i] = 0
 *         for j in range(v1.shape[0]):             # <<<<<<<<<<<<<<
 *             dotProduct[i] += v1[j,i] * v2[j,i]
 ...
 */
    ...
    for (__pyx_t_17 = 0; __pyx_t_17 < __pyx_t_16; __pyx_t_17+=1) {
      ...
      /* "/home/martin/repos/imusim/imusim/maths/vectors.pyx":85
 *         dotProduct[i] = 0
 *         for j in range(v1.shape[0]):
 *             dotProduct[i] += v1[j,i] * v2[j,i]             # <<<<<<<<<<<<<<
 *     return dotProduct
 ...
 */
  ...
  /* "/home/martin/repos/imusim/imusim/maths/vectors.pyx":86
 *         for j in range(v1.shape[0]):
 *             dotProduct[i] += v1[j,i] * v2[j,i]
 *     return dotProduct             # <<<<<<<<<<<<<<
 * 
...
/* "/home/martin/repos/imusim/imusim/maths/vectors.pyx":88
 *     return dotProduct
 * 
 * def validity(vectors):             # <<<<<<<<<<<<<<
 *     """
...
static PyObject *__pyx_pf_6imusim_5maths_7vectors_validity(PyObject *__pyx_self, PyObject *__pyx_v_vectors); /*proto*/
static char __pyx_doc_6imusim_5maths_7vectors_validity[] = "\n    Return a boolean array indicating which vectors in an array of column\n    vectors do not contain NaN values.\n    ";
static PyObject *__pyx_pf_6imusim_5maths_7vectors_validity(PyObject *__pyx_self, PyObject *__pyx_v_vectors) {
  PyObject *__pyx_r = NULL;
  PyObject *__pyx_t_1 = NULL;
  PyObject *__pyx_t_2 = NULL;
  PyObject *__pyx_t_3 = NULL;
  ...
  /* "/home/martin/repos/imusim/imusim/maths/vectors.pyx":93
 *     vectors do not contain NaN values.
 *     """
 ...
 */
  ...
  __pyx_t_4 = PyObject_Call(__pyx_t_3, __pyx_t_1, NULL); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 93; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = PyTuple_New(1); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 93; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  __pyx_t_3 = PyEval_CallObjectWithKeywords(__pyx_t_2, __pyx_t_1, ((PyObject *)__pyx_t_4)); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 93; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
...
/* "/home/martin/repos/imusim/imusim/maths/vectors.pyx":95
 *     return ~np.any(np.isnan(vectors), axis=0)
 * 
 * def nan(length=1):             # <<<<<<<<<<<<<<
 *     v = np.empty((3,length))
...
static PyObject *__pyx_pf_6imusim_5maths_7vectors_nan(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pf_6imusim_5maths_7vectors_nan(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "/home/martin/repos/imusim/imusim/maths/vectors.pyx":96
 * 
 * def nan(length=1):
 *     v = np.empty((3,length))             # <<<<<<<<<<<<<<
 *     v[:] = np.nan
 ...
 */
  ...
  __Pyx_GIVEREF(__pyx_t_1);
  __pyx_t_1 = 0;
  __pyx_t_1 = PyObject_Call(__pyx_t_2, __pyx_t_3, NULL); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 96; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  ...
  /* "/home/martin/repos/imusim/imusim/maths/vectors.pyx":97
 * def nan(length=1):
 *     v = np.empty((3,length))
 *     v[:] = np.nan             # <<<<<<<<<<<<<<
 *     return v
 */
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  if (PySequence_SetSlice(__pyx_v_v, 0, PY_SSIZE_T_MAX, __pyx_t_3) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 97; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;

  /* "/home/martin/repos/imusim/imusim/maths/vectors.pyx":98
 *     v = np.empty((3,length))
 *     v[:] = np.nan
 *     return v             # <<<<<<<<<<<<<<
 */
...
static PyMethodDef __pyx_methods[] = {
  {__Pyx_NAMESTR("vector"), (PyCFunction)__pyx_pf_6imusim_5maths_7vectors_vector, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(0)},
  {__Pyx_NAMESTR("norm"), (PyCFunction)__pyx_pf_6imusim_5maths_7vectors_norm, METH_O, __Pyx_DOCSTR(__pyx_doc_6imusim_5maths_7vectors_norm)},
  {__Pyx_NAMESTR("cross"), (PyCFunction)__pyx_pf_6imusim_5maths_7vectors_cross, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(__pyx_doc_6imusim_5maths_7vectors_cross)},
  {__Pyx_NAMESTR("dot"), (PyCFunction)__pyx_pf_6imusim_5maths_7vectors_dot, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(__pyx_doc_6imusim_5maths_7vectors_dot)},
  {__Pyx_NAMESTR("validity"), (PyCFunction)__pyx_pf_6imusim_5maths_7vectors_validity, METH_O, __Pyx_DOCSTR(__pyx_doc_6imusim_5maths_7vectors_validity)},
  {__Pyx_NAMESTR("nan"), (PyCFunction)__pyx_pf_6imusim_5maths_7vectors_nan, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(0)},
  {0, 0, 0, 0}
};
...
#endif
{
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("vectors"), __pyx_methods, __Pyx_DOCSTR(__pyx_k_9), 0, PYTHON_API_VERSION);
  #else
  ...
  /* "/home/martin/repos/imusim/imusim/maths/vectors.pyx":21
 ...
 */
  ...
  /* "/home/martin/repos/imusim/imusim/maths/vectors.pyx":27
 ...
 */
  ...
  /* "/home/martin/repos/imusim/imusim/maths/vectors.pyx":1
 * """             # <<<<<<<<<<<<<<
 * Functions for working with column vectors.
 * """
 */
  ...
  __Pyx_GOTREF(((PyObject *)__pyx_t_1));
  __pyx_t_2 = PyObject_GetAttr(__pyx_m, __pyx_n_s__norm); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  ...
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = PyObject_GetAttr(__pyx_m, __pyx_n_s__cross); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  ...
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = PyObject_GetAttr(__pyx_m, __pyx_n_s__dot); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = __Pyx_GetAttrString(__pyx_t_2, "__doc__"); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  ...
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = PyObject_GetAttr(__pyx_m, __pyx_n_s__validity); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_2 = __Pyx_GetAttrString(__pyx_t_3, "__doc__"); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
